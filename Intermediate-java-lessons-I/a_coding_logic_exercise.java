...
public class a_coding_logic_exercise {
    ...
    public static void main(String[] args) {
        ...
        int wordLength = 0;//For the logic of the program, we've to know how much letters the owrd or phrase has.
        Scanner input = new Scanner(System.in);//We declare scanner for user's input

        /*With all the variables declared
         * string for the word or phrase
         * string for the same but inverted
         * the length of the word or phrase
        ...
        while (wordLength != 0) {/*while word length is not 0(the word or phrase has for example 5 characters)
                               it will be saving starting for the last character to the first one
                               into invertedWord.
                               When it finishes, the length is now 0, the program will be out of the loop
                               saving all the */
 ...
 /*The following line is the one that does the function of inverse the phrase.
             ...
             * startIndex will be 5 this is because hello has 5 characters, -1 that means inverted word will
             add the 4th, in java the fisrt character is always 0, the 4th o, so this will be the first character
             of invertedWord.
