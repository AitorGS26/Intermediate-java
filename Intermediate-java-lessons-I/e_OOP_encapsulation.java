...
a new line of dishwashers with the following characteristics:
    ...
    2- It has to have filling, dishing and drying functions (mehods)
    3- The class has to ve well encapsuled, for avoiding future unnecesary changes by the programmers 
    of Zero
    4-The only method to import will be cycle completed. It will be the only method Zero programmers 
    will see.
