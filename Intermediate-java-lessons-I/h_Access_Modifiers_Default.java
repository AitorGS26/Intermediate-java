/* Access modifiers allow to give a major security to our clases, keeping restricted the access to different
 atributes, metthods and contructors.

 * In java we've 4 access modifiers:
 
 * public       => It allows the acces to the element from every class, it doesn't matter if it comes from
                   the same package or from other package.
 * protected    => 
 ...
 * default      => It doesn't have any reserved word asociated, it's known as default or package-private.
                   When we don specify any acces modifier, it's used the default acces modifier, this could be only be accesed by the
                   classes which are inside the same package.
