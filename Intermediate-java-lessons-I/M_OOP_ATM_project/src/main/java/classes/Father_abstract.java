/*This is going to be a little projet of a simulator for an ATM,
 it will have all the parts of this course, all the thisg we've been learning.

 * Firs of all the simulator will include next fuctions for the user:
 * 1- balance inquiry
 * 2- cash withdrawal
 * 3- cash deposit
 * 4- finish or exit
...
/*As we've seen, our projects until now, we start all by the father class, where will be
 all the atributes and methods of the program, which we will have inheritance, we've called like that because it also will be abstract.
 */
import java.util.Scanner;

public abstract class Father_abstract {

    //We've going to have inheritance of atributes (variables), and for declaring them, they'll be protected
    protected int transactions, withdrawal, deposit;
    protected static int balance;
    Scanner input = new Scanner(System.in);

    /*Abrove, we've global variables, the interaction of the user with the ATB will be
 as protected, but the balance, wich is important data, will be private.
