...
public class Thread_1 extends Thread {
    ...
    @Override //As we've seen when we do polimorfism we've to put the word override
    public void run() { //Here we start with run method for threads
        ...
        for (int i = 0; i <= 5; i++) {
            ...
            /*All thread classes are same as this one but with different letter to print. */
        }
    }
}
